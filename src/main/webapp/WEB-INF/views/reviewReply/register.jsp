...
<div class="container-fluid">
	<div style="width: 65%; float: left; text-align: justify; padding: 50px 50px 0px 50px;">
		...
		<h1 class="text-center display-4">리뷰 작성 페이지</h1>
		
		<form action="" method="get">
			<!-- 일단 임의로 get -->

			<div class="form-group display-4">
				<label class="col-form-label" for="inputDefault">리뷰제목</label> 
				<input type="text" style="font-size: 30px;" class="form-control" placeholder="제목" id="inputDefault">
			</div>
			<!-- Stars  -->
			<div class="star-box">
			...
			<div class="form-group ">
				...
				<textarea style="font-size: 30px;" class="form-control" id="exampleTextarea" rows="10"
			...
			<div id=sub>
				<input type="submit" value="작성" class="btn btn-primary"> <a
