...
import com.tabeyo.domain.ReviewAttachFileDTO;
...
public class ReviewUploadController {
	...
	@GetMapping("/reviewUploadForm")
	public void uploadForm() {
		log.info("upload form");
	}//END uploadForm()
	
	@PostMapping("/reviewUploadFormAction")
	...
	@GetMapping("/reviewUloadAjax")
	public void uploadAjax() {
		log.info("upload ajax");
	}
	
	@PostMapping("/reviewUploadAjaxAction")
	@ResponseBody
	public ResponseEntity<List<ReviewAttachFileDTO>> uploadAjaxAction(MultipartFile[] uploadFile) {
		
		log.info("UploadController uploadAjaxAction(");
		List<ReviewAttachFileDTO> list = new ArrayList<ReviewAttachFileDTO>();
		//연월일 폴더생서
	...
	@GetMapping(value="/reviewDownload", produces = MediaType.APPLICATION_OCTET_STREAM_VALUE)
	@ResponseBody
